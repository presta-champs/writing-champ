...
import type { RawKeyword } from './autocomplete';
...
/**
 * Convert a RawKeyword to our normalized KeywordData shape.
 */
export function toKeywordData(raw: RawKeyword): KeywordData {
  return {
    keyword: raw.keyword,
    volume: raw.volume,
    difficulty: raw.keyword_difficulty,
    cpc: raw.cpc,
  };
}
