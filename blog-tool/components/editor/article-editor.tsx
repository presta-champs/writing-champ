...
import { SectionRegenToolbar } from "./section-regen-toolbar";
...
type Props = {
  ...
  /** Article ID — required for section regeneration */
  articleId?: string;
};
...
export function ArticleEditor({
  ...
  return (
    ...
    >
      ...
      {/* Section regeneration floating toolbar */}
      {editable && !streaming && articleId && (
