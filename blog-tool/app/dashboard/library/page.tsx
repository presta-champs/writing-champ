...
import BulkScheduleBar from "@/components/articles/bulk-schedule-bar";
...
export default function LibraryPage() {
  ...
  const someOnPageSelected =
    paginatedIds.some((id) => selectedIds.has(id)) && !allOnPageSelected;
  ...
  return (
    <div className="max-w-6xl mx-auto">
                ...
                {paginated.map((article) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className="px-4 py-3 hidden lg:table-cell capitalize"
                        style={{ color: "var(--text-secondary)" }}
                      >
      ...
      {/* Spacer so content is not hidden behind the sticky bottom bar */}
      {selectedIds.size > 0 && <div className="h-20" />}

      {/* Bulk Schedule Bar — sticky bottom */}
      {selectedIds.size > 0 && (
        <BulkScheduleBar
